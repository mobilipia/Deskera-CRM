...
public interface CampaignManagementService {
    ...
    JSONObject getCampaigns(String companyid, String userid, String currencyid, String selectExportJson,
    ...
    JSONObject campaignExport(String companyid, String userid, String currencyid, String selectExportJson,
            String isarchive, String searchJson, String ss, String config, String isExport,
