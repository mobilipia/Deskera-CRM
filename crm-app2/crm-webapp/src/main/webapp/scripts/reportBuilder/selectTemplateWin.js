        ...
        cm: new Wtf.grid.ColumnModel([
            new Wtf.grid.RowNumberer, {
                ...
                renderer: function(val){
                    return "<div wtf:qtip=\""+val+"\"wtf:qtitle='"+WtfGlobal.getLocaleText("crm.campaigndetails.campaigntemplate.templatename")+"'>"+val+"</div>";
                }
            }]),
        ds: template_ds,
        height:180
...
<td width="50%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">               \n\
 <tr>                 <td align="left" valign="top"><strong>Company Name:</strong> Krawler Information Systems<br>    \n\
               <strong>Email Id: </strong><a href="mailto:vijay.nemade@krawler.com" target="_blank">vijay.nemade@krawler.com</a></td> \n\
...
<table width="70%" border="0" align="right" cellpadding="0" cellspacing="0">               <tr>     \n\
           ...
           </tr>               <tr>                 <td><strong>DATE</strong></td>                  <td>: 2011-08-10</td>               </tr>             </table></td>         </tr>       </table></td>   </tr>   <tr>     <td align="left" valign="top" ><table width="100%" border="0" cellpadding="2" cellspacing="0">        <tr>         <td width="7%" height="20" align="center" valign="middle" bgcolor="#EFEFEF" style="border-right:1px solid #000;border-bottom:1px solid #000;border-top:1px solid #000;border-left:1px solid #000">Sr. NO.</td>         <td width="38%" align="center" valign="middle" bgcolor="#EFEFEF" style="border-right:1px solid #000;border-bottom:1px solid #000;border-top:1px solid #000">PRODUCT DESCRIPTION</td>         <td width="18%" align="center" valign="middle" bgcolor="#EFEFEF" style="border-right:1px solid #000;border-bottom:1px solid #000;border-top:1px solid #000">QUANTITY</td>         <td width="15%" align="center" valign="middle" bgcolor="#EFEFEF" style="border-right:1px solid #000;border-bottom:1px solid #000;border-top:1px solid #000">UNIT PRICE</td>         <td width="22%" align="center" valign="middle" bgcolor="#EFEFEF" style="border-bottom:1px solid #000;border-top:1px solid #000;border-right:1px solid #000">LINE TOTAL</td>        </tr>       <tr>         <td align="center" valign="middle" style="border-right:1px solid #000;border-left:1px solid #000;border-bottom:1px solid #000"> </td>         <td align="center" valign="middle" style="border-right:1px solid #000;border-bottom:1px solid #000"> </td>         <td align="center" valign="middle" style="border-right:1px solid #000;border-bottom:1px solid #000"> </td>         <td align="center" valign="middle" style="border-right:1px solid #000;border-bottom:1px solid #000"> </td>         <td align="center" valign="middle" style="border-right:1px solid #000;border-bottom:1px solid #000">&nbsp; </td><td>                 </td></tr>       <tr>         <td align="center" valign="middle"> </td>         <td align="center" valign="middle"> </td>         <td align="center" valign="middle"> </td>         <td align="right" valign="middle" style="padding-right:5px;border-right:1px solid #000">TOTAL</td>          <td height="25" align="center" valign="middle" style="border-right:1px solid #000;border-bottom:1px solid #000">1000.0</td>       </tr>     </table></td>   </tr>   <tr>     <td height="20" align="left" valign="top"> </td>   </tr>   \n\
/<tr>      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >       <tr>         <td height="30" align="left" valign="middle">Memo : Thank you for your Enquiry. We look forward to work with you</td>       </tr>     \n\
    ...
    template_ds.load(); 
    var emptypreview="<div style='font-size:14px;margin-top:175px;text-align:center;'>"+WtfGlobal.getLocaleText("crm.exportinterface.template.notemplate")+"</div>";
    ...
    this.templateWindow = new Wtf.Window({
        title:WtfGlobal.getLocaleText({key:"crm.exportinterface.template.title",params:[this.isreport?'Report':'']}),//'Existing '+(this.isreport?'Report':'')+ ' Templates',
        modal:true,
        ...
        width:600,
        buttons:[{
            text:WtfGlobal.getLocaleText("crm.exportinterface.template.selcolumns"),//'Select Columns',
            tooltip:{text:WtfGlobal.getLocaleText("crm.exportinterface.template.selcolumns.ttip")},//'Choose columns to be exported.'},
            scope:this,
            ...
            hidden : !this.isreport,
            tooltip:{text:WtfGlobal.getLocaleText("crm.exportinterface.template.exportbtnttip")},//'Export as pdf file using selected report template.'},
            handler:function() {
            ...
            tooltip:{text:WtfGlobal.getLocaleText("crm.exportinterface.template.editbtn.ttip")},//'Edit selected report template.'},
            handler: function() {
                var smTmp = namePanel.getSelectionModel();
                if(smTmp.getCount()<1){
                    WtfComMsgBox(792,0);
                    ...
                    this.newEditTemplate(smTmp.getSelected().data['configstr'],smTmp.getSelected().data['letterhead'],smTmp.getSelected().data['pretext'],smTmp.getSelected().data['posttext']);
            },
            scope:this
        },{
            text:WtfGlobal.getLocaleText("crm.DELETEBUTTON"),//'Delete',
            tooltip:{text: WtfGlobal.getLocaleText("crm.exportinterface.template.delbtn.ttip")},//'Delete selected report template.'},
            handler:function(){
                var smTmp = namePanel.getSelectionModel();
                if(smTmp.getCount()<1){
                    WtfComMsgBox(792, 0);
                    ...
                    Wtf.MessageBox.confirm(WtfGlobal.getLocaleText("crm.msgbox.CONFIRMTITLE"), WtfGlobal.getLocaleText("crm.exportinterface.template.delbtn.confirmmsg"),function(btn) {    //'Are you sure to delete the selected template?',function(btn) {
                        if(btn =='yes') {
                            Wtf.Ajax.requestEx({
                            ...
                            function(res) {
                                if(res.success){
                                    ...
                                    if(this.templatetype>0) {
                                        ...
                                        this.tabObj.template.setValue(WtfGlobal.getLocaleText("crm.exportinterface.template.seltemplatemask"));//"Select a Template...");
                                    }
                                }
                            },
                            function() {
            ...
            text:WtfGlobal.getLocaleText("crm.exportinterface.template.createtemplate"),//'Create New',
            tooltip:{text:WtfGlobal.getLocaleText("crm.exportinterface.template.createtemplate.ttip")},//'Create new report template before exporting.'},
            handler:function() {
...
Wtf.extend(Wtf.selectTempWin,Wtf.Window,{
    ...
    newEditTemplate: function(configstr,letterhead,pretext,posttext) {
        ...
        if(eobj === undefined){
            eobj = new Wtf.reportBuilder.builderPanel({
                title: "<span wtf:qtip='"+WtfGlobal.getLocaleText("crm.exportinterface.template.tabtitle")+"'>"+Wtf.util.Format.ellipsis(WtfGlobal.getLocaleText("crm.exportinterface.template.tabtitle"),18)+"</span>",
...
Wtf.TemplatePreview=function(store){
        ...
        var emptypreview="<div style='font-size:14px;margin-top:175px;text-align:center;'>"+WtfGlobal.getLocaleText("crm.exportinterface.template.notemplate")+"</div>";//"There is no template created till now.</div>";
        if(store.getTotalCount()>0){
            emptypreview="<div style='font-size:14px;margin-top:175px;text-align:center;'>"+WtfGlobal.getLocaleText("crm.exportinterface.template.seltemplate")+"</div>";//"Select a Template to preview.</div>";
        }
