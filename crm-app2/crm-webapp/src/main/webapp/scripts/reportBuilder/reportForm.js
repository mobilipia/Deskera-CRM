...
Wtf.customReport=function(config){
    ...
    this.hfieldset=new Wtf.Panel({
        ...
        items:[{
            xtype:'fieldset',
            title: WtfGlobal.getLocaleText("crm.template.headerfields"),//'Header Fields',
            cls: "customFieldSet",
            defaults : defConf,
            autoHeight : true,
            items:[
                this.headernote=new Wtf.form.TextField({
                    fieldLabel:WtfGlobal.getLocaleText("crm.template.headernote"),//'Header Note',
                    labelSeparator:'',
                    maxLength:100,
                    validator:WtfGlobal.validateHTField,
                    maxLengthText:WtfGlobal.getLocaleText("crm.template.headernote.valmsg"),//'You cannot enter more than 100 characters',
                    emptyText:WtfGlobal.getLocaleText("crm.template.insertnote")//'Insert Note'
                }),
                this.reporttitle = new Wtf.form.TextField({
                    fieldLabel:WtfGlobal.getLocaleText("crm.template.reporttitle"),//'Report Title',
                    labelSeparator:'',
                    maxLength:40,
                    validator:WtfGlobal.validateHTField,
                    maxLengthText:WtfGlobal.getLocaleText("crm.template.reporttitle.valmsg"),//'You cannot enter more than 40 characters',
                    emptyText:WtfGlobal.getLocaleText("crm.template.inserttitle")//'Insert Title'
                })]
            }
        ]
    });
    ...
    this.fpager= new Wtf.form.Checkbox({
                    name:'pager',
                    boxLabel:WtfGlobal.getLocaleText("crm.template.paging"),//'Paging',
    ...
    this.hdater= new Wtf.form.Checkbox({
                    name:'dater',
                    boxLabel:WtfGlobal.getLocaleText("crm.calendar.agendaview.header.date"),//'Date',
                    labelSeparator:'',
                    cls:baseCls,
    ...
    this.customForm=new Wtf.FormPanel({
        ...
        items:[{
            border: false,
            html: '<center><div style="padding-top:10px;color:#154288;font-weight:bold"> '+WtfGlobal.getLocaleText({key:"crm.template.header",params:[doctype]})+'</div><hr style = "width:95%;"></center>'
        },{
            layout:'column',
            border: false,
            ...
            items:[{
                ...
                items:[{
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.pageborder"),//'Page Border',
                    cls: "customFieldSet",
                    defaults : defConf,
                    autoHeight : true,
                    items:[
                        ...
                        name:'pborder',
                        inputValue :'true',
                        boxLabel:WtfGlobal.getLocaleText("crm.template.withborder"),//'With Border',
                        cls:baseCls,
                        labelSeparator:'',
                        checked:true
                        }),
                        ...
                        labelSeparator:'',
                        cls:baseCls,
                        boxLabel:WtfGlobal.getLocaleText("crm.template.noborder")//'No Border'
                        })
                    ]
                },{
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.datangridborder"),//'Data and Grid Border',
                    cls: "customFieldSet",
                    defaults : defConf,
                    autoHeight : true,
                    items:[
                ...
                {
                    xtype:'fieldset',
                    title:WtfGlobal.getLocaleText("crm.template.selbgcolor"),// 'Select Background Color',
                    cls: "customFieldSet",
                ...
                items:[{
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.pageview"),//'Page View',
                    cls: "customFieldSet",
                    defaults : defConf,
                    autoHeight : true,
                    items:[
                        ...
                        name:'pview',
                        inputValue :'false',
                        boxLabel:WtfGlobal.getLocaleText("crm.template.portrait"),//'Portrait',
                        cls:baseCls,
                        labelSeparator:''
                    }),
                        ...
                        inputValue :'true',
                        labelSeparator:'',
                        boxLabel:WtfGlobal.getLocaleText("crm.template.landscape"),//'Landscape',
                        cls:baseCls,
                        checked:true
                    })]
                },{
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.companylogo"),//'Company Logo',
                    ...
                    items:[
                        ...
                        inputValue :'false',
                        id:'hidelogo'+this.id,
                        boxLabel:WtfGlobal.getLocaleText("crm.template.hidelogo"),//'Hide Logo',
                        cls:baseCls,
                        labelSeparator:'',
                        checked:true
                    }),
                        ...
                        labelSeparator:'',
                        cls:baseCls,
                        boxLabel:WtfGlobal.getLocaleText("crm.template.showlogo"),//'Show Logo',
                        checked: false
                    }),
                    {   xtype:'radio',       
                        name:'complogo',
                        ...
                        labelSeparator:'',
                        cls:baseCls,
                        boxLabel:this.templatetype==1?WtfGlobal.getLocaleText("crm.template.letterhead"):"",//Letter Head
                        ...
                        text:WtfGlobal.getLocaleText("crm.ADDTEXT"),//"Add",
                        id:'addletterhad',
                        hidden:true,
                        scope:this,
                        handler:function(){
                ...
                {
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.seltxtcolor"),//'Select Text Color',
                    cls: "customFieldSet",
        ...
        },
        {
            ...
            items:[{
                ...
                items:[{
                    xtype:'fieldset',
                    title: WtfGlobal.getLocaleText("crm.template.footerfields"),//'Footer Fields',
                    cls: "customFieldSet",
                    defaults : defConf,
                    autoHeight : true,
                    items:[
                        this.footernote = new Wtf.form.TextField({
                            ...
                            fieldLabel:WtfGlobal.getLocaleText("crm.template.footernote"),//'Footer Note',
                            maxLength:100,
                            validator:WtfGlobal.validateHTField,
                            maxLengthText:WtfGlobal.getLocaleText("crm.template.headernote.valmsg"),//'You cannot enter more than 100 characters',
                            labelSeparator:'',
        	...
        	items:[{
        			...
        			items:[{
        				...
        				buttons:[
        				         {
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.template.viewtemplatelist")+'</b>',//'<b>View Template List<b>',
        				             cls:'exportpdfbut',
        				             scope:this,
        				             handler:function(){
        				         ...
        				         {
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.exportinterface.exportreporttitle")+'</b>',//'<b>Export Report<b>',
        				             cls:'exportpdfbut',
        				         ...
        				         {
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.template.savetemplate")+'</b>',//'<b>Save Template<b>',
        				             cls:'exportpdfbut',
        				             scope:this,
        				             handler:function(){
        				                 if (this.customForm.getForm().isValid())
        				         ...
        				         {
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.template.savetemplatenexportreport")+'</b>',//'<b>Save Template and Export Report</b>',
        				             cls:'exportpdfbut',
        				             scope:this,
        				             hidden:this.editTemplateConfig!=undefined && this.templatetype!=1?false:true,
        				             handler:function(){
        				         ...
        				         {
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.template.pretext")+'</b>',//'<b>Pre Text</b>',
        				             cls:'exportpdfbut',
        				             hidden:this.templatetype==1?false:true,
        				             scope:this,
        				             handler:function(){
        				             ...
        				             xtype:'button',
        				             text:'<b>'+WtfGlobal.getLocaleText("crm.template.posttext")+'</b>',//'<b>Post Text</b>',
        				             hidden:this.templatetype==1?false:true,
        				             cls:'exportpdfbut',
        				             scope:this,
        			...
        			items:[{
        	        	xtype:'panel',
         	        	border:false,
        	    		html : "<img src='images/help.png' title='Click here' onclick = 'showHelp(88)' />"
        	    	}]
...
Wtf.extend(Wtf.customReport,Wtf.Panel,{ 
    ...
    if(this.editTemplateConfig==undefined) {
        ...
        var Template = new Wtf.Window({
                title: WtfGlobal.getLocaleText("crm.template.newreporttemplate"),//'New Report Template',
                width: 390,
                layout: 'border',
                iconCls : 'iconwin',
                modal: true,
                ...
                items:[{
                    ...
                    items:[{
                        xtype:'fieldset',
                        title:WtfGlobal.getLocaleText("crm.contact.defaultheader.desc"),//"Description",
                        cls: 'textAreaDiv',
                        labelWidth:0,
                        frame:false,
                        border:false,
                ...
                buttons:[{
                    ...
                    handler: function() {
                        if(!nameField.isValid()) 
                          WtfComMsgBox([WtfGlobal.getLocaleText("crm.campaigndetails.newtemplate"),WtfGlobal.getLocaleText("crm.template.fillessentialmsg")]);//'Please fill all the essential fields.']);
                         else {
    ...
    generateData:function(){
         ...
         var data = '{"landscape":"'+pv+'","pageBorder":"'+pb+'","gridBorder":"'+gb+'","title":"'+title +'","subtitles":"'+subtitles +'","headNote":"'+headNote+'","showLogo":"'+cl +'","headDate":"'+headDate+'","footDate":"'+footDate+'","footPager":"'+footPager+'","headPager":"'+headPager+'","footNote":"'+footNote+'","textColor":"'+tColor+'","bgColor":"'+bColor+'","lHead":"'+lHead+'"}';
         return data;
    },
