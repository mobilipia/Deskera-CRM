...
Wtf.KwlGridPanel = function(config){
 ...
 this.MSComboconfig = {
    ...
    this.bbar=pag;
    this.searchLabel = this.searchLabel ? this.searchLabel : WtfGlobal.getLocaleText("crm.goalsettings.qsearch.label");//"Quick Search ";
    ...
    this.searchByLabel=this.searchByLabel ?this.searchByLabel: "Search By "
    ...
    this.store.on("datachanged", function(){
        if(this.serverSideSearch && this.pPageSizeObj && this.pPageSizeObj.combo){
