				...
				tag: "div", id: "node_" + this.nodeid, cls: this.nodeClass, children: [{
                    ...
                    tag: 'div', id: this.blockId + this.nodeid, cls: this.mainDivStyle, children: [{
                        ...
                        tag : "div", cls : "blocktop " + this.handleclass, children : [{
                            ...
                            tag : "span", id: "name_" + this.handleclass, html : "<div wtf:qtip=\""+this.nodeNameTip+"\"wtf:qtitle='User'>"+this.nodeName+"</div>"
                        }]
                    }, {
                        tag : "div", cls : "blockbottom", children : [{

                            tag : "span", id: "desc_" + this.nodeid, html : "<div wtf:qtip=\""+this.nodeDesignationTip+"\"wtf:qtitle='Role(s)'>"+this.nodeDesignation+"</div>"
                        }, {
                            tag : "a" , title : "Edit User", cls : this.detailsIcon, children : [{

                                tag : "span", html : ""
                            }]
                        }, {
                            tag : "a" , title : "Map Node", cls : this.mapIcon, children : [{

                                tag : "span", html : ""
                            }]
                        }, {
                            tag : "a" , title : "Edit Parent", cls : this.editIcon, children : [{

                                tag : "span", html : ""
                            }]
                        }, {
                            tag : "a" , title : "Unmap Node", cls : this.unmapIcon, children : [{
