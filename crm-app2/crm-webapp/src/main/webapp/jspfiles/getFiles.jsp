...
<%@ page import="com.krawler.spring.companyDetails.companyDetailsHandler"%>
...
<%
    ...
    if(sessionbean.isValidSession(request, response)){
        try {
            ...
            String companyid = sessionbean.getCompanyid(request);
            String userId = sessionbean.getUserid(request);
            int action = Integer.parseInt(request.getParameter("action"));
            hiberSession = HibernateUtil.getCurrentSession();
            
            String subdomain = companyDetailsHandler.getSubDomain(request);
            switch(action){
                ...
                case 2: //upload a new file
                    ...
                    String file_id = "";
                    String file_extn = "";
                    String basePath = storageHandlerImpl.GetDocStorePath() + companyid + "/" + fType ;
                    String filename = "";
