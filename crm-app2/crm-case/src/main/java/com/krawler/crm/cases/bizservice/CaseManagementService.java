...
public interface CaseManagementService {
    ...
    JSONObject getCases(String companyid, String userid, String currencyid, String selectExportJson, String accountFlag,
    ...
    JSONObject caseExport(String companyid, String userid, String currencyid, String selectExportJson, String accountFlag,
            String isarchive, String mapid, String searchJson, String ss, String config, String isExport,
