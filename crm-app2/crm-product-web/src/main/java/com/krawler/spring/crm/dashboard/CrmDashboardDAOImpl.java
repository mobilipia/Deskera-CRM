...
public class CrmDashboardDAOImpl extends BaseDAO implements CrmDashboardDAO {
    ...
    public KwlReturnObject insertWidgetIntoState(HashMap<String, Object> requestParams) throws ServiceException {
        ...
        try {
            ...
            throw ServiceException.FAILURE("crmDashboardDAOImpl.insertWidgetIntoState : "+e.getMessage(), e);
        }
    ...
    public KwlReturnObject removeWidgetFromState(HashMap<String, Object> requestParams) throws ServiceException {
        ...
        try {
            ...
            logger.warn(e.getMessage(), e);
            throw ServiceException.FAILURE("crmDashboardDAOImpl.removeWidgetFromState : "+e.getMessage(), e);
        }
        return new KwlReturnObject(true,"002","",ll,dl);
    }
    ...
    public KwlReturnObject changeWidgetState(HashMap<String, Object> requestParams) throws ServiceException {
        ...
        try {
            ...
            logger.warn(e.getMessage(), e);
            throw ServiceException.FAILURE("crmDashboardDAOImpl.changeWidgetState : "+e.getMessage(), e);
        }
        return new KwlReturnObject(true,"002","",ll,dl);
    }
    ...
    public KwlReturnObject getWidgetStatus(HashMap<String, Object> requestParams) throws ServiceException {
        ...
        try {
            ...
            logger.warn(e.getMessage(), e);
            throw ServiceException.FAILURE("crmDashboardDAOImpl.getWidgetStatus : "+e.getMessage(), e);
        } catch (Exception e) {
            logger.warn(e.getMessage(), e);
            throw ServiceException.FAILURE("crmDashboardDAOImpl.getWidgetStatus : "+e.getMessage(), e);
        }
    ...
    public static JSONObject insertDefaultWidgetState() throws ServiceException {
        ...
        try {
            ...
            col1 = "{'id':'DSBMyWorkspaces'},{'id':'lead_drag'},{'id':'top_activity_drag'}";
            col3 = "{'id':'reports_drag'}";
            jobj = new JSONObject("{'col1':" + (!col1.equals("") ? "[" + col1 + "]" : "[]") + ",'col2':" + (!col2.equals("") ? "[" + col2 + "]" : "[]") + ",'col3':" + (!col3.equals("") ? "[" + col3 + "]" : "[]") + "}");
        } catch(JSONException e) {
            LogFactory.getLog(CrmDashboardDAOImpl.class).warn(e.getMessage(), e);
            throw ServiceException.FAILURE("crmDashboardDAOImpl.insertDefaultWidgetState : "+e.getMessage(), e);
        }
        return jobj;
    }
