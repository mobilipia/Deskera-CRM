...
import com.krawler.dao.SequencerDAO;
...
public class SequencerServiceImpl implements SequencerService{
    ...
    public void setSequencerDao(SequencerDAO sequencerDao) {
    ...
    public Long getNext(String tableName) {
        ...
        Long value = sequencerDao.getCurrentValue(sequenceName);
        sequencerDao.setCurrentValue(sequenceName, value+1);
        return value;
    }
}
