...
public class FilterClause implements Clause {
	...
	public FilterClause addFilter(int mode, String queryStr){
		switch(mode){
			case AND: queryString.append(" and ").append(queryStr);	break;
			case OR: queryString.append(" or ").append(queryStr); break;	
		}
		return this;
	}
	...
	public FilterClause addFilter(int mode, FilterClause clause){
		switch(mode){
			case AND: queryString.append(" and ").append(clause.queryString);	break;
			case OR: queryString.append(" or ").append(clause.queryString); break;	
		}
		return this;
	}
