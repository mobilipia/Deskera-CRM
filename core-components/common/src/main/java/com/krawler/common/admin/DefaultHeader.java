...
public class DefaultHeader {
    ...
    private String dbcolumnrefname;        // Entry of reference column of multiselect combo from custom column
    ...
    public String getDbcolumnrefname() {
        return dbcolumnrefname;
    }

    public void setDbcolumnrefname(String dbcolumnrefname) {
        this.dbcolumnrefname = dbcolumnrefname;
    }
