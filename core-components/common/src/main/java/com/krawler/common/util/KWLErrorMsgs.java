...
public interface KWLErrorMsgs {
        ...
        String pmsgEmailMarketNotific = "Hi %s,\n\n Please find the status of the Email Marketing Campaign as follows :" +
                "\n\n Campaign started on : %s\n\n\nCampaign Name : %s\n\n\nEmail Marketing Name : %s\n\n\nMails Sent : %s\n\n\nFailed/Bounced Mails : %s\n\n\nResult : Email marketing campaign was sent to %s targets successfully.";
        String htmlmsgEmailMarketNotific = "<html><head><title>Deskera CRM - Email Marketing Campaign Status Report</title></head><style type='text/css'>"
                                + "a:link, a:visited, a:active {\n"
                                + " 	color: #03C;"
                                + "}\n"
                                + "body {\n"
                                ...
                                + "		<p>Please find the status of the Email Marketing Campaign as follows :</p>"
                                + "             "
                                + "		<p>Campaign started on : %s</p>"
                                + "		<p>Campaign Name : %s</p>"
                                + "		<p>Email Marketing Name : %s</p>"
                                + "		<p>Mails Sent : %s </p>"
                                + "		<p>Failed/Bounced Mails : %s </p>"
                                + "     <p>Result : Email marketing campaign was sent to %s targets successfully.</p>"
                                + "	</div></body></html>";
...
//        String errMsgFileFormatBAsecamp = "Error occurred while parsing file. Please uplaod proper xml file";
        ...
        String S01 = "Success";
        String F01 = "Failure";
        String hrmsGoalADD = "Goal has been added successfully.";
        String hrmsGoalEDIT = "Goal has been updated successfully.";
