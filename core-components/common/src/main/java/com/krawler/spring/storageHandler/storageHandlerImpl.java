...
public class storageHandlerImpl {
    ...
    public static String GetServerTimezone() {
        return ConfigReader.getinstance().get("SERVER_TIMEZONE");
    }
    ...
    public static String GetEmailUploadFilePath() {
        return ConfigReader.getinstance().get("EmailUploadFile");
    }
    ...
    public static String GetNewsLetterAddress() {
		return ConfigReader.getinstance().get("NewsLetterAddress");
	}
}
