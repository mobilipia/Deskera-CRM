...
public class firstRunHelpDAOImpl extends BaseDAO implements firstRunHelpDAO {
    ...
    /* (non-Javadoc)
     * @see com.krawler.spring.firstRunHelp.firstRunHelpDAO#getModule()
     */
    ...
    /* (non-Javadoc)
     * @see com.krawler.spring.firstRunHelp.firstRunHelpDAO#getComponents(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.krawler.spring.firstRunHelp.firstRunHelpDAO#getCompDetails(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.krawler.spring.firstRunHelp.firstRunHelpDAO#saveCompDetails(java.util.HashMap)
     */
    public KwlReturnObject saveCompDetails(HashMap<String, Object> requestParams) throws ServiceException {
        ...
        try {
            if (requestParams.containsKey("id") && !requestParams.get("id").toString().equals("")) {
                EditHelp help = (EditHelp) get(EditHelp.class, requestParams.get("id").toString());
