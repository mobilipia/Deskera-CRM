...
public interface ImportDAO {
    ...
    public Object createFileTable(String filename, int cols) throws ServiceException;
    public Object removeFileTable(String tablename) throws ServiceException;
    public Object dumpFileRow(String filename, Object[] dataArray) throws ServiceException;
...
//	List<Object[]> getColumnHeader(String companyId, List<String> headerIds);
	...
	void linkCustomData(String module);
}
