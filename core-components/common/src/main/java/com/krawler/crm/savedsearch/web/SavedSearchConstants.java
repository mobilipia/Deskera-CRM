...
public class SavedSearchConstants {
    ...
    public static String JSON_searchid="searchid";
    public static String JSON_module="module";
    public static String JSON_searchname="searchname";

    public static String JSON_searchstate="searchstate";
    public static String JSON_searchName="searchName";
