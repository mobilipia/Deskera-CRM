...
*/
package com.krawler.crm.savedsearch.dao;
...
import com.krawler.crm.savedsearch.web.SavedSearchConstants;
...
public class SavedSearchDAOImpl extends BaseDAO implements SavedSearchDAO {
    ...
    @Override
    public List getSavedSearchQuery(String userid,String searchname) throws ServiceException {
