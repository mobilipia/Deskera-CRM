...
public class ConfigReader {
	...
	private static final String CONFIG_FILE_LOCATION = "com.krawler.config.location"; 
	
	private static final String CONFIG_FILE_NAME = "krawler-web-app.xml";
	...
	public ConfigReader() {
		resourceNames.add("config/krawler-web-app.xml");
	...
	public URL getResource(String name) {
		URL configUrl = null;
		String configDir = System.getProperty(CONFIG_FILE_LOCATION);
		
		boolean useConfigRoot = false;
		...
		{
			try {
				configUrl = new URL(configDir + (configDir.endsWith("/")? "": "/") + CONFIG_FILE_NAME);
		...
		{
			configUrl = classLoader.getResource(name);
		}
	...
	private String getResourceAsString(String name) {
		...
		String configUrl = configDir + (configDir.endsWith(fileSeparator)? "": fileSeparator) + CONFIG_FILE_NAME;
