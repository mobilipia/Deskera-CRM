 ...
 * @author krawler-user
 */
public class LogicalAndExpression extends BinaryExpression implements ConditionalExpression {
    ...
    public boolean getConditionValue() throws ProcessException {
        if(operand==null||Boolean.FALSE.equals(operand.getValue()))
            return false;
        else if(otherOperand==null||Boolean.FALSE.equals(otherOperand.getValue()))
            return false;
        else
            return true;
    }
