...
public class AddExpression extends BinaryExpression {
    ...
    public Object getValue() throws ProcessException {
        Object v1=operand.getValue();
        Object v2=otherOperand.getValue();
        if(v1 instanceof Number && v2 instanceof Number)
            return add((Number)v1,(Number)v2);

        throw new UnsupportedOperationException("addition of value other than numbers not supported");
    }
