 ...
 */
public class JsonDummyNodeParser extends JsonNodeParser {
    public JsonDummyNodeParser(NodeParser successor) {
        super(successor);
    }
    ...
    public boolean canCompose(FlowNode node) {
        return node!=null && node instanceof DummyNode;
    }
