 ...
 * @author krawler-user
 */
public class LogicalOrExpression extends BinaryExpression implements ConditionalExpression {
    ...
    public boolean getConditionValue() throws ProcessException {
        if(operand!=null&&Boolean.TRUE.equals(operand.getValue()))
            return true;
        else if(otherOperand!=null&&Boolean.TRUE.equals(otherOperand.getValue()))
            return true;
        else
            return false;
    }
